...
const themes = {
  ...
  ghost:
    'shadow-none border-gray-200 text-gray-700 bg-white/75 dark:border-slate-700 hover:bg-gray-200/75 dark:bg-slate-800/80 dark:hover:bg-slate-700/80 dark:text-slate-200 focus:ring-primary-500',
  tertiary:
